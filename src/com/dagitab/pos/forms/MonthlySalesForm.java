...
import com.dagitab.pos.main.FileFilterMaker;
					...
					jButton1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent evt) {
						    ...
						    if(returnVal == JFileChooser.APPROVE_OPTION) {
						    	...
						    	boolean success = com.dagitab.pos.reports.MonthlySales.generate(chooser.getSelectedFile().getAbsolutePath()+".xls", db, storeCode, year,month);
