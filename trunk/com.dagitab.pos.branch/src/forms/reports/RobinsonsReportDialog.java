...
*/
public class RobinsonsReportDialog extends javax.swing.JDialog {
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				RobinsonsReportDialog inst = new RobinsonsReportDialog(frame);
				inst.setVisible(true);
			}
		});
	}
	
	public RobinsonsReportDialog(JFrame frame) {
		super(frame);
		initGUI();
	}
		...
		try {
			{
				...
				this.setTitle("Robinsons Sales Report");
				this.setModal(true);
				{
		...
		if(closeAbstractAction == null) {
			closeAbstractAction = new AbstractAction("Close", null) {
				public void actionPerformed(ActionEvent evt) {
					RobinsonsReportDialog.this.dispose();
				}
			};
		}
