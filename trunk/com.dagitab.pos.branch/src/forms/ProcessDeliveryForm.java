	...
	*/
	...
	private void initGUI() {
		try {
			...
			{
				jLabel1 = new JLabel();
				getContentPane().add(jLabel1, new AnchorConstraint(18, 265, 85, 23, AnchorConstraint.ANCHOR_REL, AnchorConstraint.ANCHOR_REL, AnchorConstraint.ANCHOR_REL, AnchorConstraint.ANCHOR_REL));
				jLabel1.setText("Delivery Items");
